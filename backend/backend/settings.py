...
SECRET_KEY = 'django-insecure-)m1x61k*q+zd@fr3d_s9b353%jg_ee#hm7ms^_&u-u8$2u49iu'
...
SIMPLE_JWT = {
    ...
    # as soon as users are active, a refresh token will be generated for them with the ROTATE_REFRESH_TOKENS set to True
